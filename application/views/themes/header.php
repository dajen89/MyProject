...
<html lang="en">
  <head>
    ...
    <title>Aneka Gudang Site Online Shop</title>
...
// If cart is empty, this will show below message.
 ...
 ?>
      ...
      <div class="list-group">
           <a href="<?php echo base_url()?>page/tambah_produk" class="list-group-item"><strong><i class="glyphicon glyphicon-shopping-cart"></i> TAMBAH PRODUK</strong></a>            
      </div>
